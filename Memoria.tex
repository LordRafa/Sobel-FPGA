...
\section*{}
\paragraph{}
A mis abuelos, padres, hermano y resto\newline
de familia. Sin ellos yo no me encontraría\newline
donde estoy hoy, ni llegaría a donde\newline
estaré mañana.
...
\paragraph{}
En esta sección se mostrarán los resultados de los experimentos realizados. Para preparar los experimentos se tomaron varias muestras no consecutivas mediante el uso de la función congelar frame. La unidad utilizada en las medidas es el número de ciclos de CPU necesarios para dibujar un frame. En las figuras~\ref{fig:imagenoriginal}~y~\ref{fig:imagensobel} se pueden ver la imagen original utilizada en los experimentos y la imagen resultante de aplicar el Sobel.

\begin{figure}[p]
\centering
\includegraphics[width=0.80\textwidth]{./figuras/NEEK/Original.png}
\caption{Imagen Original}
\label{fig:imagenoriginal}
\end{figure}

\begin{figure}[p]
\centering
\includegraphics[width=0.80\textwidth]{./figuras/NEEK/Sobel.png}
\caption{Imagen Sobel}
\label{fig:imagensobel}
\end{figure}
...
\raggedbottom
\lstinputlisting[caption=alt\_tpo\_lcd.h,label=lst:alttpolcdh,linerange=30-60,firstnumber=30]{./SISSources/C/alt_tpo_lcd.h}
\flushbottom
\clearpage
...
\raggedbottom
\lstinputlisting[caption=alt\_video\_display.h,label=lst:altvideodisplayh,linerange=30-87,firstnumber=30]{./SISSources/C/alt_video_display.h}
\flushbottom
\clearpage

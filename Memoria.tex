...
\paragraph{}
Otro de los requisito hardware es desarrollar un subsistema de vídeo que se encargue de adaptar la de vídeo proveniente de la entrada de vídeo a un formato que pueda ser manipulado fácilmente y mostrado por el LCD.
...
\paragraph{}
Para dejar constancia de las acciones realizadas se ha desarrollado una memoria del proyecto, este documento, que contiene toda la información del mismo. También se ha desarrollado una presentación del proyecto para ser expuesto ante el tribunal de evaluación.

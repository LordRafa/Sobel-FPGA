...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../RawaPro.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../SistemaPrincipal.sopcinfo
...
# Design Name 
# setting SOPC_NAME is SistemaPrincipal
SOPC_NAME := SistemaPrincipal
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2000120
SOPC_SYSID_FLAG += --sidp=0x2000120
ELF_PATCH_FLAG  += --sidp 0x2000120

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1366222715
SOPC_SYSID_FLAG += --timestamp=1366222715
ELF_PATCH_FLAG  += --timestamp 1366222715
